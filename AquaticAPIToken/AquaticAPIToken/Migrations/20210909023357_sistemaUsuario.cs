        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    asunto = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    perdido = table.Column<int>(type: "int", nullable: false),
                    promedioPartidas = table.Column<int>(type: "int", nullable: false),
                    bajas = table.Column<int>(type: "int", nullable: false),
                    caidas = table.Column<int>(type: "int", nullable: false),
                    promediobaja = table.Column<int>(type: "int", nullable: false),
                    promedioCaidas = table.Column<int>(type: "int", nullable: false),
                    fecha = table.Column<DateTime>(type: "datetime", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Persona", x => x.correoElectronico);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idUsuarioPersona = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonaUsuario", x => x.idUsuarioPersona);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_usuarioEstadistica", x => x.id);
                });
